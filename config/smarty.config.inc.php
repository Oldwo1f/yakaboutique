...
if(!file_exists(_PS_MODULE_DIR_.'pproperties/smarty/smarty.config.inc.php')){@ini_set('display_errors','on');@error_reporting(E_ALL);}require_once(_PS_MODULE_DIR_.'pproperties/smarty/smarty.config.inc.php');
