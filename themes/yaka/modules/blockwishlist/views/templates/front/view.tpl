                                ...
                                <div class="wishlist_product_detail">
                                    <p class="form-group">
                                        ...
                                        <input class="form-control grey" type="text"
                                               ...
                                               value="{PP::resolveQty($product.quantity,$product.quantity_fractional)|formatQty}" size="6"/> {$product|pp:qty_text}<span id="total_quantity_{$product.id_product}_{$product.id_product_attribute}" style="display:none">{PP::resolveQty($product.quantity,$product.quantity_fractional)}</span>
                                    </p>
                                    ...
                                    <div class="btn_action">
                                        {if (isset($product.attribute_quantity) && $product.attribute_quantity >= 1) || (!isset($product.attribute_quantity) && $product.product_quantity >= 1) || (isset($product.allow_oosp) && $product.allow_oosp)}
                                            ...
                                            <a
                                                    ...
                                                    onclick="WishlistBuyProduct('{$token|escape:'html':'UTF-8'}', '{$product.id_product}', '{$product.id_product_attribute}', 'quantity_{$product.id_product}_{$product.id_product_attribute}', this, {$ajax});"
