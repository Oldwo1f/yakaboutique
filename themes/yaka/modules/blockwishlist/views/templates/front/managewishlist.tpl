                            ...
                            <div class="product_infos">
                                ...
                                <div class="wishlist_product_detail">
                                    <p class="form-group">
                                        ...
                                        <input type="text" class="form-control grey" id="quantity_{$product.id_product}_{$product.id_product_attribute}" value="{PP::resolveQty($product.quantity,$product.quantity_fractional)|formatQty}" size="6"/> {$product|pp:qty_text}
                                    </p>
