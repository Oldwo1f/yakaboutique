...
<div id="special_block_right" class="block">
    ...
    {if $special}
		<ul>
        	<li class="clearfix">
            <a class="products-block-image content_img clearfix" href="{$special.link|escape:'html':'UTF-8'}" title="{$special.name|escape:'html':'UTF-8'}">

                    <img 
                    class="replace-2x img-responsive" 
                    src="{$link->getImageLink($special.link_rewrite, $special.id_image, 'mini')|escape:'html':'UTF-8'}" 
