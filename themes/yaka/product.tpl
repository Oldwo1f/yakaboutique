...
<div itemscope itemtype="http://schema.org/Product">
	<div class="primary_block row">
		...
		<!-- pb-right-column-->
		<div class="pb-right-column col-xs-12 col-sm-8 col-md-4 col-md-offset-2">
		...
		<div class="page-product-box">
			...
			{if isset($features) && $features}
					{foreach from=$features item=feature}
						...
						{if $feature.name == "CULTURE?" && $feature.value == "BIO"}
							<a class="" href="">
								<span class="labelbio"><img src="themes/yaka/img/Agriculture-bio.png" width="50px" height="50px" alt=""></span>
							</a>
						{/if}
						{/if}
					{/foreach}
			...
			{/if} -->
			{if ($display_qties  ==  1 && $pproperties.pp_qty_available_display != 2 && !$PS_CATALOG_MODE && $PS_STOCK_MANAGEMENT && $product->available_for_order)}
			...
			{if isset($HOOK_EXTRA_RIGHT) && $HOOK_EXTRA_RIGHT}{/if}
			{if !$content_only}
				<ul id="usefull_link_block" class="clearfix no-print">
					{if $HOOK_EXTRA_LEFT}{/if}
...
{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
				...
				<div id="quantityDiscount">
					<table class="std table-product-discounts">
						...
						<tbody>
							...
							<tr id="quantityDiscount_{$quantity_discount.id_product_attribute}" class="quantityDiscount_{$quantity_discount.id_product_attribute}" data-discount-type="{$quantity_discount.reduction_type}" data-discount="{$quantity_discount.real_value|floatval}" data-discount-quantity="{$quantity_discount.quantity|floatval}">
								<td>
		...
		{/if}
		<!--HOOK_PRODUCT_TAB -->
		<section class="page-product-box avis">
			{$HOOK_PRODUCT_TAB}
