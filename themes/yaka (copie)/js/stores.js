...
function initMarkers()
{
	...
	downloadUrl(searchUrl, function(data) {
		...
		for (var i = 0; i < markerNodes.length; i++)
		{
			...
			createMarker(latlng, name, address, other, id_store, has_store_picture,note);
...
function createMarker(latlng, name, address, other, id_store, has_store_picture,note)
{
	var html = '<b>'+name+'</b><br/>'+note+'<br/>'+address+(has_store_picture === 1 ? '<br /><br /><img src="'+img_store_dir+parseInt(id_store)+'.jpg" alt="" />' : '')+other+'<br /><a href="http://maps.google.com/maps?saddr=&daddr='+latlng+'" target="_blank">'+translation_5+'<\/a>';
