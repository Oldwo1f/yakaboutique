	...
	<tr>
		...
		<td style="width: 85%; text-align: right">
			<table style="width: 100%; font-size: 8pt;">
				...
				{else}
					{foreach $order_details as $order_detail }{ppAssign order=$order_detail pdf=true}
					{cycle values='#FFF,#DDD' assign=bgcolor}
					<tr style="line-height:6px;background-color:{$bgcolor};">
						<td style="text-align: left; width: 60%">{displayProductName name=$order_detail.product_name}</td>

						<td style="text-align: center; width: 10%">{displayQty quantity=$order_detail.product_quantity}{ppAssign}</td>
