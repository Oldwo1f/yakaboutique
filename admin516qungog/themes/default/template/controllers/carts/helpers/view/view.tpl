		...
		<div class="row">
			<table class="table" id="orderProducts">
				...
				{foreach from=$products item='product'}
					{ppAssign cart=$product currency=$currency bo=true}
					{assign var='productHasCustomizedDatas' value=Product::hasCustomizedDatas($product, $customized_datas)}
					{if $productHasCustomizedDatas && isset($customized_datas[$product.id_product][$product.id_product_attribute][$product.id_address_delivery])}
						<tr>
							<td>{$product.image}</td>
							...
							<td class="text-center productQuantity">{displayQty quantity=$product.customization_quantity}</td>
							<td class="text-center productQuantity">{displayQty quantity=$product.qty_in_stock m='inline'}</td>
							<td class="text-right">{displayWtPriceWithCurrency price=$product.total_customization_wt currency=$currency quantity=$product.customization_quantity m='total'}</td>
						</tr>
					...
					{if $product.cart_quantity > $product.customization_quantity}
						<tr>
							...
							<td class="text-center">{math equation='x - y' x=$product.cart_quantity y=$product.customization_quantity|intval assign=quantity}{displayQty quantity=$quantity}</td>
							<td class="text-center">{displayQty quantity=$product.qty_in_stock m='inline'}</td>
							<td class="text-right">{displayWtPriceWithCurrency price=$product.product_total currency=$currency quantity=$quantity m='total'}</td>
						</tr>
					{/if}
				{/foreach}
				{ppAssign}
